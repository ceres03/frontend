    ...
    <div className='h-full bg-[#fdfff6] p-14 mt-5' >
        <article className='flex justify-center '>
            <div className='flex flex-col border rounded-3xl p-20'>
                ...
                <p className='sobre mt-5'>Estou extremamente grato ao Grupo 3 pelo comprometimento e dedicação. Juntos, superamos os obstáculos e criamos uma ferramenta que pode ter um impacto real e positivo na comunidade e na sustentabilidade agrícola. É uma conquista que nos enche de orgulho e reforça a importância de trabalhar em prol de causas tão significativas.</p>
            </div>
